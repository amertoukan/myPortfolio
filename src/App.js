  ...
  render() {
    ...
    return (
      ...
      <Header className="landing-bg" title={<Link style={{textDecoration: 'none', color: 'white'}} to="/">Amer Toukan</Link>} scroll>
          ...
          <Drawer classname = "clearfix" style = {{background: '#1D4350'}}title = {<Link className ='title clearfix'  style={{color: 'white', textDecoration: 'none', paddingBottom: 0, justifyContent: 'center'}}to="/">Amer Toukan</Link>}>
